...
test.1 <- landings_catches %>%
  dplyr::group_by(land_id, vessel_number, species_code, scientific_name) %>%
...
dm <- vegdist(test.1[5:17], method="bray", na.rm = T)


#Do a PERMANOVA

permanova <- adonis(dm~ docking_date_yy*season*vessel_number, data = test.1[1:4])
permanova
